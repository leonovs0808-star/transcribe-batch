...
руками — отправь **вот эту ссылку**:

> https://raw.githubusercontent.com/leonovs0808-star/transcribe-batch/master/INSTALL-FOR-AI.md

в чат с Claude или ChatGPT **на том же компьютере**, где будешь ставить
скрипт (нужен доступ к Терминалу — на телефоне это не сработает), и напиши:
**"установи и настрой мне это по этой инструкции"**. Дальше ИИ проведёт тебя
за руку: проверит, что нужно, поставит недостающее, поможет получить
бесплатный ключ и запустит первую расшифровку. Ссылку выше нужно скинуть
именно как есть — по ней ИИ сразу откроет саму инструкцию, а не общую
